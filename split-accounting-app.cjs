...
console.log('🔧 تقسيم ملف AccountingApp.tsx...\n');

const originalFile = 'client/src/pages/AccountingApp.tsx';
const content = fs.readFileSync(originalFile, 'utf8');
const lines = content.split('\n');

console.log(`📄 إجمالي الأسطر: ${lines.length}\n`);

// 1. استخراج الدوال المساعدة (Utilities)
console.log('📦 استخراج الدوال المساعدة...');
const utilsContent = `// @ts-nocheck
...
fs.writeFileSync('client/src/utils/accounting.tsx', utilsContent, 'utf8');
console.log('✅ تم إنشاء client/src/utils/accounting.tsx\n');

console.log('✨ تم التقسيم بنجاح!\n');
console.log('📊 الملفات المنشأة:');
console.log('   • client/src/types/accounting.ts - الثوابت والأنواع');
console.log('   • client/src/utils/accounting.tsx - الدوال المساعدة');
