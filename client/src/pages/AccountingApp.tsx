...
const InventoryWithdrawalComponent = ({ data, handleDataAction, handleDelete, showToast, handleRefresh, currentUser }) => {
    ...
    const handleBarcodeChange = useCallback((value) => {
        setItemForm(prev => {
            const match = data.inventory.find(item => item.barcode === value);
            if (match) {
                return {
                    ...prev,
                    barcode: value,
    ...
    const handleAddItemToWithdrawal = (e) => {
        ...
        const inventoryItem = data.inventory.find(i => normalizeTextForSearch(i.name) === normalizedName || (itemForm.barcode && i.barcode === itemForm.barcode));
        ...
        const itemPayload = {
            ...
            barcode: inventoryItem.barcode || itemForm.barcode || '',
                    ...
                    <form onSubmit={handleAddItemToWithdrawal} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value={itemForm.category || '—'}
                                readOnly
                                className="w-full p-2 border rounded-lg bg-gray-100 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
                            />
                        </div>
